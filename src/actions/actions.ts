...
export const GET_GIFT_CARDS = (setModal: (v: JSX.Element) => void) => {
    return async (dispatch: ThunkDispatch<any, {}, AnyAction>) => {
        ...
        try {
            let response = await fetch(
                "https://jsonblob.com/api/jsonBlob/1213904680530075648"     // gift_cards
            )
            if (response.ok) {
            ...
            response = await fetch(
                "https://jsonblob.com/api/jsonBlob/1213906085470920704"     // presentcard_main
            )
            if (response.ok) {
...
export const SEND_MY_CARDS = (userId: number, addArrMyCards: IDataMyCard[], setModal: (v: JSX.Element) => void) => {
    return async () => {
        ...
        try {
            let response = await fetch(
                'https://jsonblob.com/api/jsonBlob/1213904969941245952'        // users
            )
            if (response.ok) {
...
export const GET_ENTERTAINMENT_NEWS = (setModal: (v: JSX.Element) => void) => {
    return async (dispatch: ThunkDispatch<any, {}, AnyAction>) => {
        try {
            const response = await fetch(
                'https://jsonblob.com/api/jsonBlob/1213905316894072832'        // entertainment_news
            )
            if (response.ok) {
...
export const GET_NEWSPAGE_NEWS = (setModal: (v: JSX.Element) => void) => {
    return async (dispatch: ThunkDispatch<any, {}, AnyAction>) => {
        try {
            const response = await fetch(
                'https://jsonblob.com/api/jsonBlob/1213905672667521024'        // newsPage_news
            )
            if (response.ok) {
...
export const GET_SEAT_TYPES = (setModal: (v: JSX.Element) => void) => {
    return async (dispatch: ThunkDispatch<any, {}, AnyAction>) => {
        try {
            const response = await fetch(
                'https://jsonblob.com/api/jsonBlob/1213906922070990848'        // seat_types
            )
            if (response.ok) {
...
export const GET_MAIN_VISA = (setModal: (v: JSX.Element) => void) => {
    return async (dispatch: ThunkDispatch<any, {}, AnyAction>) => {
        try {
            const response = await fetch(
                'https://jsonblob.com/api/jsonBlob/1213905936317276160'        // main_visa
            )
            if (response.ok) {
...
export const GET_ROOMS = (setModal: (v: JSX.Element) => void) => {
    return async (dispatch: ThunkDispatch<any, {}, AnyAction>) => {
        try {
            const response = await fetch(
                'https://jsonblob.com/api/jsonBlob/1213906767364087808'        // rooms
            )
            if (response.ok) {
